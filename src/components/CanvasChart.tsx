...
function CanvasChart() {
    ...
    const arcAnimation = () => {
        ...
        arc!.style.cssText = "transform-origin: bottom;transform: rotate(-50deg);"
    }

    const resetAnimation = () => {
        var arc = document.getElementById("arc");
        arc!.style.cssText = "transform-origin: bottom;transform: rotate(-134deg);"
    }
        ...
        <div>
            <div className="container">
                <div className="canvas__box">
                    ...
                    <div className="canvas__arc" id='arc'>
                    </div>
                </div>
            </div>
            <button onClick={() => arcAnimation()}>Check Animation</button>
